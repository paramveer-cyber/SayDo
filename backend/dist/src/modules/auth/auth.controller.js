...
import { getTenantCorsair, evictTenantFromCache, } from "../../common/utils/corsair-tenant.js";
import { setupGmailWatch, stopGmailWatch, syncAllMessages, } from "../gmail/gmail.services.js";
...
import { findUserById, findUserByRefreshToken, setUserRefreshToken, deleteUserById, rotateRefreshToken, setUserPluginConnected, } from "./auth.queries.js";
import { ApiError } from "../../common/utils/api-error.js";
import { ok, created } from "../../common/utils/response.js";
import { COOKIE_OPTS } from "../../common/config/cookie-opts.js";
import { db } from "../../db/index.js";
import { corsairAccounts, corsairEntities, corsairEvents, } from "../../db/schema.js";
...
export const refresh = async (req, res, next) => {
    try {
        const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiIzMTdkNmY2Ny0yY2ZlLTRmY2EtYmNlNi1jZDdkMGZiM2I0MjAiLCJpYXQiOjE3ODIxNjM3MzEsImV4cCI6MTc4Mjc2ODUzMSwiaXNzIjoiU2F5RG8ifQ.LglznVSof4VJQOk2dRPtJ2nQ_xdwvP9ZhD40EDia_D4";
        if (!token)
    ...
    try {
        ...
        if (result.plugin === "gmail") {
            ...
            const [existingGmailAccount] = await db
                ...
                .where(and(eq(corsairAccounts.tenantId, result.tenantId), eq(corsairAccounts.integrationId, "gmail")))
                .limit(1);
...
export const disconnectPlugin = async (req, res, next) => {
    try {
        ...
        const [corsairAccountRow] = await db
            .select()
            .from(corsairAccounts)
            .where(and(eq(corsairAccounts.tenantId, userId), eq(corsairAccounts.integrationId, pluginId)))
            .limit(1);

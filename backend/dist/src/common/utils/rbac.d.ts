...
export type WorkflowId = "email-priority" | "weekly-digest" | "daily-digest" | "unsubscribe-suggestions" | "followup-scan" | "bulk-cleanup" | "week-prep-briefing" | "conflict-detection";

...
export class GmailController {
    ...
    getMessage = async (req, res, next) => {
        try {
            const message = await gmailServices.getMessage(this.getTenant(req), req.params.messageId, req.query);
    ...
    getThread = async (req, res, next) => {
        try {
            const thread = await gmailServices.getThread(this.getTenant(req), req.params.threadId, req.query);
    ...
    listLabels = async (_req, res, next) => {
        try {
            const labels = await gmailServices.listLabels(this.getTenant(_req));

...
gmailRouter.post(
  ...
  validate(batchModifyMessagesBody),
  gmailController.batchModifyMessages,
);
...
gmailRouter.post(
  ...
  gmailController.untrashMessage,
);
gmailRouter.patch(
  "/messages/:messageId",
  validate(modifyMessageBody),
...
gmailRouter.patch(
  "/threads/:threadId",
  validate(modifyThreadBody),
  gmailController.modifyThread,
);
...
gmailRouter.post(
  "/drafts",
  validate(createDraftBody),
  gmailController.createDraft,
);
gmailRouter.put(
  "/drafts/:draftId",
  validate(updateDraftBody),
  gmailController.updateDraft,
);
